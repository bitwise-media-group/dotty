...
- A **[mise package directory](../guides/packages.md)** that makes your package
  set reproducible — locked tools plus the Homebrew bottles and casks mise pours
  for you.
...
- macOS (or Linux). Homebrew is optional: mise pours bottles and casks into the
  Homebrew prefix itself, and `dotty init` installs mise when the machine has
  none.
